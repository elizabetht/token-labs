...
echo "  • AI Gateway Route (AIGatewayRoute for multi-model routing)"
echo "  • Kuadrant (Authorino, Limitador, policies, tenant secrets)"
echo "  • Envoy Gateway + AI Gateway controller + Redis"
echo "  • Gateway API + AI Gateway CRDs"
echo ""
...
echo ""
echo "==> Step 2/6: Removing AI Gateway Route..."
"${SCRIPT_DIR}/uninstall-05-ai-gateway-route.sh"
